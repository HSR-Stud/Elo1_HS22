...
\begin{tabular}{c c c c c}
  ...
  \includegraphics[height = 3.5cm]{img/DAC/Parallelverfahren.png}
   & \includegraphics[width = 3.5cm]{img/DAC/Wägeverfahren.png}
   & \includegraphics[width = 3.5cm]{img/DAC/Wägeverfahren_Ströme.png}
   & \includegraphics[width = 3.5cm]{img/DAC/C-DAC.png}
   & \includegraphics[width = 3.5cm]{img/DAC/R-2R-DAC.png}
  \\ \includegraphics[width = 3.5cm]{img/DAC/DAC_mit_Zählverfahren.png}
   & \includegraphics[width = 3.5cm]{img/DAC/Kaskadierte_Wandler.png}
   & \includegraphics[width = 3.5cm]{img/DAC/Zyklischer_DAC.png}
   & \includegraphics[width = 3.5cm]{img/DAC/Pipelined_DAC.png}
   & \includegraphics[width = 3.5cm]{img/DAC/Multiplizierender_Wanlder.png}
  \\ \includegraphics[height = 3.5cm]{img/DAC/Exponentieller_DAC.png}
\end{tabular}
